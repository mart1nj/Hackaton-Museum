...
namespace Open.Sentry.Controllers {
    ...
    public class AccountController : Controller {
        ...
        [HttpGet] [AllowAnonymous] public async Task<IActionResult> Login(string returnUrl = null) {
        ...
        public async Task<IActionResult> LoginWith2Fa(LoginWith2FaViewModel model, bool rememberMe,
            ...
            var result = await signInManager.TwoFactorAuthenticatorSignInAsync(authenticatorCode,
            ...
            logger.LogWarning("Invalid authenticator code entered for user with ID {UserId}.",
                user.Id);
        ...
        public async Task<IActionResult> LoginWithRecoveryCode(LoginWithRecoveryCodeViewModel model,
            ...
            if (result.Succeeded) {
                logger.LogInformation("User with ID {UserId} logged in with a recovery code.",
                    user.Id);
                return redirectToLocal(returnUrl);
            }
            ...
            logger.LogWarning("Invalid recovery code entered for user with ID {UserId}",
                user.Id);
            ModelState.AddModelError(string.Empty, "Invalid recovery code entered.");
            return View();
        }

        [HttpGet] [AllowAnonymous] public IActionResult Lockout() {
            return View();
        }
        ...
        [HttpGet] [AllowAnonymous] public IActionResult ResetPassword(string code = null) {
            if (code == null) {
